...
#define qfp_fmul(a,b) 0
#define qfp_fdiv(a,b) 1
...
extern q7_t inline add_q7( const q7_t v1, const q7_t dec1, const q7_t v2, const q7_t dec2, const q7_t ret_dec )
{
	int32_t v;
	int8_t  dec = dec1;
...
extern q7_t inline mult_q7( const q7_t v1, const q7_t dec1, const q7_t v2, const q7_t dec2, const q7_t ret_dec )
{
...
extern q7_t inline scale_q7( const q7_t v1, const q7_t v2, const q7_t dec2 )
{
	return (q7_t) __SSAT( (v1 * v2) >> dec2, 8 );
}

extern q7_t inline div_q7( const q7_t v1, const q7_t dec1, const q7_t v2, const q7_t dec2, const q7_t ret_dec )
{
...
extern q7_t inline ratio_q7( const q7_t v1, const q7_t v2, const q7_t ret_dec )
{
	return (q7_t) __SSAT( (((int32_t)v1) << ret_dec) / v2, 8 );
}

extern q15_t inline one_minus_q15( const q15_t v2, const q7_t dec )
{
	return (q15_t) __SSAT( (((int16_t)1) << dec) - v2, 16 );
}

extern q15_t inline scale_q15( const q15_t v1, const q15_t v2, const q7_t dec2 )
{
	return (q15_t) __SSAT( (v1 * v2) >> dec2, 16 );
}

extern q15_t inline ratio_q15( const q15_t v1, const q15_t v2, const q7_t ret_dec )
{
...
int16_t SelectDetectionsAboveScoreThreshold( const q7_t * values, int16_t n,
...
int16_t softNonMaxSuppressionSingleClass_Float( const BoxCornerEncodingFloat * bboxes,
											const float * keep_scores,
											const int16_t num_kept,
...
int16_t softNonMaxSuppressionSingleClass_Q7( const BoxCornerEncodingFloat * bboxes,
											...
											const ssd_detector_opt opt )
{
	...
	// int16_t scores[num_kept];               // Qx.14 
	 int16_t scores[10]; // this is wrong, but let's compile first
							...
							const ssd_detector_opt opt )
{
	...
	//     num_kept = SelectDetectionsAboveScoreThreshold(
	...
	// threshold confidence scores
	int16_t	keep_indices[MAX_NUM_BOXES];
	q7_t	keep_scores[MAX_NUM_BOXES];
		
	int16_t	num_kept;
	if ( opt.considering_BG == 0 )
		num_kept = SelectDetectionsAboveScoreThreshold(
			conf, MAX_NUM_BOXES, opt.threshold_score, keep_scores, keep_indices);
	else
		num_kept = SelectDetectionsAboveScoreThresholdConsideringBG(
			conf, MAX_NUM_BOXES, opt.threshold_score, keep_scores, keep_indices);
